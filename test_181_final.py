...
parser.add_argument("--edgefeats_path", type=str, default='/home/mijia/egpdi_evolla/af3_data/dataset_dir_315/test_315/edge_features/EdgeFeats_predicted_SC_17_181.pkl')
...
test_path= root_dir + 'Test_315.txt'
pkl_path= root_dir +'dataset_dir_315/'+ 'PPIS_residue_feas_PSA.pkl' #加H意味着用HMM特征
esm2_5120_path= root_dir + 'esm2/'
dis_path= root_dir + 'dataset_dir_315/'+'PPIS_psepos_SC.pkl'
...
print("Test_315 performance on our method")
